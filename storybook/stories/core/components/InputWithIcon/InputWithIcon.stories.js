import Input from '@orangehrm/oxd/core/components/InputWithIcon/InputWithIcon.vue';
import InputEvents from './InputWithIconEvents.story.vue';

export default {
  title: 'Inputs/TextWithIcon',
  component: Input,
  argTypes: {
    modelValue: {
      control: {type: 'object'},
