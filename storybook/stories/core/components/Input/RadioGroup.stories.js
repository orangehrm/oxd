import RadioGroupStory from './RadioGroup.story.vue';
import RadioGroupEvents from './RadioGroupEvents.story.vue';
...
export default {
  ...
  argTypes: {
    style: {
      control: {type: 'object'},
      table: {
        type: {summary: 'Set custom style to the radio buttons'},
      },
    },
    options: {
      control: {type: 'array'},
    ...
    modelValue: {
      control: {type: 'text'},
      table: {
        type: {summary: 'Set value to the radio buttons'},
      },
    },
    'update:modelValue': {
      control: {type: 'text'},
    ...
    disabled: {
      ...
      table: {
        type: {
          summary:
            'Disable the radio buttons (Individual radio buttons can be disabled via the options)',
        },
      },
    },
    class: {
    ...
    id: {
      ...
      table: {
        type: {
          summary: 'Set individual radio id prefix',
        },
      },
    },
    focus: {
...
const Template = (args) => ({
  ...
  components: {'oxd-radio-group-story': RadioGroupStory},
  template: '<oxd-radio-group-story v-bind="args" />',
});
...
export const Events = () => RadioGroupEvents;
