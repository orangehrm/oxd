...
describe('Comment.vue', () => {
  ...
  it('enable edit mode and update comment', async () => {
    const wrapper = mount(Comment, {
      props: {
        comment: comment,
        allowToEdit: true,
    ...
    await wrapper.vm.$nextTick();
    const editButton = wrapper.find('[data-test="editIcon"]');
    ...
    expect(wrapper.vm.commentContent).toEqual('new comment');
  ...
  it('enable delete mode and delete comment', async () => {
    ...
    await wrapper.vm.$nextTick();
    const deleteConfirmationButton = wrapper.find('[data-test="deleteButton"]');
    deleteConfirmationButton.trigger('click');
  });

  it('enable delete mode and cancel delete', async () => {
    const wrapper = mount(Comment, {
      props: {
        comment: comment,
        allowToEdit: false,
    ...
    deleteButton.trigger('click');
    await wrapper.vm.$nextTick();
    const cancelDeleteConfirmationButton = wrapper.find(
      '[data-test="cancelButton"]',
    );
    cancelDeleteConfirmationButton.trigger('click');
  });

  it('when group by none the section titles are visible inside comments', async () => {
    const wrapper = mount(Comment, {
      props: {
        comment: comment,
        allowToEdit: true,
