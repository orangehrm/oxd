...
export const ICON_SIZES = [ICON_SIZE_XXX_SMALL, ICON_SIZE_XX_SMALL, ICON_SIZE_EXTRA_SMALL, ICON_SIZE_SMALL, ICON_SIZE_MEDIUM, ICON_SIZE_LARGE, ICON_SIZE_EXTRA_LARGE];
