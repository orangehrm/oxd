...
describe('SchemaForm.vue', () => {
    ...
    it('text, date  input are disabled when the form is disabled', () => {
      ...
      expect(wrapper.findComponent(Input).find('input').element.disabled).toBeTruthy();
    });
    ...
    it('text area input is disabled when the form is disabled', () => {
      ...
      expect(wrapper.findComponent(TextArea).find('textarea').element.disabled).toBeTruthy();
    });
