...
describe('ClassicTable.vue', () => {
  it('renders OXD ClassicTable', () => {
    const wrapper = mount(ClassicTable, {
      props: {
        headers: [
            ...
            {name: 'col2', title: 'Column 2', width: '20%', style: {border: 'solid 1px #D3D3D3', 'border-radius': '0.5rem', 'padding': '5px 10px', 'width': 'fit-content'}},
    ...
    expect(items[4].attributes().style).toBe('border: 1px solid #d3d3d3; border-radius: 0.5rem; padding: 5px 10px;');
  });
